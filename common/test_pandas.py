...
europa = df[df["region"].str.contains("Europe", na=False)]

top5_europa = europa.sort_values("populacja", ascending=False).head(5)

print(top5_europa[["nazwa", "populacja", "region"]])